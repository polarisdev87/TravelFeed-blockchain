...
const NewsletterPreview = props => {
  ...
  {{#each updates}}
      ...
      <!--[if (gte mso 9)|(IE)]>
        <td valign="top" style="padding: 0px 0px 0px 0px;border-collapse: collapse;" >
      <![endif]-->
          {{#if image}}
      <table  style="border-spacing:0;border-collapse:collapse;margin:0px 0px 0px 0px;"
              cellpadding="0"
              cellspacing="0"
              align="left"
              border="0"
      ...
      <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
        <tr>
          <td style="font-size:6px;line-height:10px;padding:0px 0px 0px 0px;" valign="top" align="center">
            <img class="max-width" border="0" style="display:block;color:#000000;text-decoration:none;font-family:Helvetica, arial, sans-serif;font-size:16px;max-width:100% !important;width:100%;height:auto !important;" src="https://steemitimages.com/480x0/{{image}}" alt="" width="292.5">
          </td>
        </tr>
      </table>
      ...
      <table  
         {{#if image}}
              style="border-spacing:0;border-collapse:collapse;margin:0px 0px 0px 0px;"
      ...
      <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
        <tr>
          <td style="padding:0px 0px 0px 0px;line-height:22px;text-align:inherit;"
              ...
              valign="top"
              bgcolor="">
              <div style="text-align:justify;margin:0px 5px 0px 5px;" align="justify">{{{text}}}</div>
          </td>
        </tr>
      </table>
